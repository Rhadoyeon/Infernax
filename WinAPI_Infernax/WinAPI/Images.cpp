...
#pragma region 배틀씬 1-9
	...
	//IMAGEMANAGER->addFrameImage("레이저2", ENEMY"AncientWormLaser2.bmp", 3132, 126, 2, 1, true, COLORDEL);
	...
	IMAGEMANAGER->addFrameImage("레비아탄_입수", ENEMY"LeviathanDown.bmp", 945, 786, 3, 2, true, COLORDEL);
	IMAGEMANAGER->addFrameImage("레비아탄_레이저", ENEMY"LeviathanLaser.bmp", 1575, 768, 5, 2, true, COLORDEL);
	IMAGEMANAGER->addFrameImage("레비아탄_화염뿜기", ENEMY"LeviathanFire.bmp", 1260, 786, 4, 2, true, COLORDEL);
	IMAGEMANAGER->addFrameImage("레비아탄_불", ENEMY"LeviathanFire1.bmp", 846, 468, 6, 2, true, COLORDEL);
	IMAGEMANAGER->addFrameImage("레비아탄_죽음", ENEMY"LeviathanDie.bmp", 945, 786, 3, 2, true, COLORDEL);

	// 레비아탄 & 고대웜 공동
	IMAGEMANAGER->addFrameImage("레이저볼", ENEMY"LaserBall.bmp", 324, 372, 2, 2, true, COLORDEL);
	IMAGEMANAGER->addFrameImage("레이저", ENEMY"Laser.bmp", 6264, 126, 4, 1, true, COLORDEL);
	IMAGEMANAGER->addFrameImage("레비아탄_레이저스킬", ENEMY"LeviathanLaserSkill.bmp", 15660, 126, 10, 1, true, COLORDEL);

	// 배틀씬 10
	IMAGEMANAGER->addImage("늑대인간배경", BG"LycanthropeBG.bmp", 1368, 769, true, COLORDEL);
